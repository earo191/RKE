...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <form action="{{route('banco.update', $cuentaBancaria->id)}}"  method="POST" ">
                    ...
                    <div class="card-header" id="headingOne" style="">
                        <h2 class="mb-0">
                            ...
                            <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                <i class="fa fa-mobile"></i>Edita Tu Cuenta Bancaria
                            </button>
                        </h2>
                    </div>
                    <div class="card-body">
                        <div class="row ">
                            ...
                            <div class="col-md-6">
                                ...
                                <div style="display: flex">
                                    <div style="display: flex">
                                        <input id="codigo_banco" type="text" name="codigo_banco" class="form-control col-md-2" value="{{$cuentaBancaria->codigo_banco}}"  style="pointer-events: none;">
                                        <input id="nro_cuenta" type="text" name="nro_cuenta" class="form-control" value="{{$cuentaBancaria->Nro_Cuenta}}" >
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row ">
                            <div class="col-md-6">
                                ...
                                <select name="Tipo_cuenta" class="form-control">
                                    @if ($cuentaBancaria->Tipo_cuenta == 1)
