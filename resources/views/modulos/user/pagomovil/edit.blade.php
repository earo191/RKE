                    ...
                    <div class="card-header" id="headingOne" style="">
                        <h2 class="mb-0">
                            ...
                            <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                <i class="fa fa-mobile"></i>Edita Tu Pago Movil
                            </button>
                        </h2>
                    </div>
                    <div class="card-body">
                        <div class="row ">
                            ...
                            <div class="col-md-2">
                                ...
                                <select class="form-control" name="codigo_telefono" id="">
                                    <option value="{{$pagomovil->codigo}}">{{$pagomovil->codigo}}</option>
                            ...
                            <div class="col-md-4">
                                ...
                                <input id="telefono" type="text" name="telefono" class="form-control" value="{{$pagomovil->telefono}}" >
                            </div>
                        </div>
                        <div class="row ">
                            <div class="col-md-6">
                                <label class="labels">Rif</label>
                                <input id="rif" type="text" name="rif" class="form-control"  value="{{$pagomovil->rif}}" >
                            </div>
                            <div class="col-md-6">
